...
public class HorseConfig
{
    ...
    public static class Common {
        ...
        public boolean enableSizes = true;

        @Config.LangKey("If enabled, horses will be spooked by monsters and throw their rider.")
        public boolean spookyHorses = false;

        @Config.LangKey("If enabled, horse herds can follow a horse even if it is ridden or on a lead.")
        public boolean herdsFollowRidden = true;

        @Config.LangKey("If enabled, stallions will chase each other away from mares.")
        public boolean jealousStallions = true;
        ...
        public boolean useGeneticAnimalsIcons = true;
    }
    ...
    public static class Growth {
        ...
        public boolean growGradually = false;
    ...
    public static class Breeding {
        ...
        public boolean autobreeding = false;
    }
