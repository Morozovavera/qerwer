...
public class EquineGenome extends Genome {
    ...
    public float getBaseHealth() {
        if (HorseConfig.GENETICS.enableHealthEffects) {
    ...
    public float getHealth() {
        ...
        if (HorseConfig.COMMON.enableSizes) {
    ...
    public List<List<String>> getBookContents() {
        ...
        if (HorseConfig.GENETICS.bookShowsGenes) {
            test_results.add(Util.translate("book.genetic_color"));
            listGenes(test_results, colorgenelist);
            if (HorseConfig.COMMON.enableSizes && this.species != Species.DONKEY) {
